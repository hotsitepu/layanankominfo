...
class Admin extends CI_Controller {
    ...
    public function printwebdesa(){
       
        $data['print'] = $this->m_website_desa->tampil_data();
        $this->load->view('admin/print_webdesa', $data);
    }
    ...
    public function printhakweb(){
       
        $data['print'] = $this->m_hak_akses_web->tampil_data();
        $this->load->view('admin/print_hakweb', $data);
    }
    ...
    public function printhakmabu(){
       
        $data['print'] = $this->m_hak_akses_matur_bupati->tampil_data();
        $this->load->view('admin/print_hakmabu', $data);
    }
    ...
    public function printfasint(){
       
        $data['print'] = $this->m_fasilitas_inter_wifi->tampil_data();
        $this->load->view('admin/print_fasinternet', $data);
    }
    ...
    public function printfast(){
        ...
        $data['print'] = $this->m_fasilitas_video_conference->tampil_data();
        $this->load->view('admin/print_fastvidio', $data);
    }
    ...
    public function printadupewe(){
       
        $data['print'] = $this->m_aduan_pengelolaan_website->tampil_data();
        $this->load->view('admin/print_adupewe', $data);
    }
    ...
    public function printinfjar(){
       
        $data['print'] = $this->m_aduan_jaringan_internet->tampil_data();
        $this->load->view('admin/print_infjar', $data);
    }
